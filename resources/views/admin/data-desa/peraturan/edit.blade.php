...
<div class="p-8">
    <div class="mb-6">
        ...
        <h1 class="mt-3 text-3xl font-bold text-blue-900">Edit Peraturan Desa</h1>
    </div>
    ...
    <form action="{{ route('admin.data-desa.peraturan.update', $peraturan) }}" method="POST" class="max-w-4xl rounded-2xl bg-white p-6 shadow-md">
        @csrf
        @method('PUT')
