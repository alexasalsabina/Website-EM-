    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">
                Masukkan data perangkat desa baru untuk ditampilkan pada struktur pemerintahan.
            </p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       placeholder="Contoh: Bapak Arif Rahman"
                       required>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="keterangan"
                          ...
                          class="w-full rounded-lg border border-gray-300 px-4 py-2.5
                                 focus:outline-none focus:ring-2 focus:ring-blue-600
                                 focus:border-blue-600"
                          placeholder="Contoh: Memimpin penyelenggaraan pemerintahan desa dan koordinasi perangkat desa.">{{ old('keterangan') }}</textarea>
            </div>
