<section class="quick-menu">
    ...
    <a href="{{ route('profil.potensi') }}" class="quick-menu__item">
        <span class="quick-menu__icon">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 21V10l4-3 4 3 4-3 4 3v11" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>
                <circle cx="12" cy="6" r="1.3" stroke="currentColor" stroke-width="1.4"/>
                <path d="M4 21h16" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
            </svg>
        </span>
        <span class="quick-menu__label">BUMDES</span>
    </a>
