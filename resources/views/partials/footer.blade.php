<footer class="bg-white border-t border-gray-200 text-gray-800 py-8 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div class="leading-snug">
            ...
            <p class="text-sm text-gray-700">Kabupaten Malang, Jawa Timur</p>
        </div>

        <!-- Alamat & Kontak -->
        <div class="text-sm text-gray-700 space-y-1">
            <p class="font-bold text-gray-900">Kantor Desa Jatisari :</p>
            <p>Jl. Contoh Alamat No. 1, Jatisari, Kec. Contoh, Kabupaten Malang, Jawa Timur 65100, Indonesia</p>
            <p>
        ...
        <div class="pt-2 text-sm text-gray-700">
            <p>© {{ date('Y') }} Jatisari - Website ini dibangun dan dikelola oleh <strong class="font-bold text-gray-900">PSID Jatisari</strong></p>
        </div>
