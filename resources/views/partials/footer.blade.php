<footer class="bg-white border-t border-gray-200 text-gray-800 pt-8 pb-6 mt-auto w-full">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <!-- 1. POJOK KIRI: Logo & Nama Desa -->
            <div class="flex-1 flex items-center gap-1 min-w-[260px] mt-5">
                
                <!-- 1. UBAH LOGO DI SINI -->
                <img src="{{ asset('images/Malang.jpg') }}" alt="Logo Kabupaten Malang" class="h-20 w-auto flex-shrink-0 object-contain">
                
                <div class="flex flex-col justify-center">
                    <!-- 2. UBAH TULISAN & UKURAN TEKS DI SINI -->
                    <h3 class="text-base font-bold text-gray-900 leading-tight">Desa Jatisari</h3>
                    
                    <!-- 3. UBAH SUB-TEKS KECAMATAN/KABUPATEN DI SINI -->
            ...
            <div class="flex-1 flex flex-col items-center text-center space-y-2.5 min-w-[200px] mt-5">
                ...
                <div class="flex items-center justify-center gap-4 pt-1">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/nama_halaman_facebook_desa" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    ...
                    <!-- Youtube -->
                    <a href="https://www.youtube.com/@nama_channel_youtube_desa" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                ...
                <div>
                    <a href="/kebijakan-privasi" class="text-xs text-gray-600 hover:underline">Kebijakan Privasi</a>
                </div>
            </div>
        </div>
