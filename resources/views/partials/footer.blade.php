<footer class="bg-white border-t border-gray-200 text-gray-800 pt-8 pb-6 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- BARIS ATAS: Bagi 3 Kolom (Kiri, Tengah, Kanan) -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 pb-6 border-b border-gray-200">
            
            <!-- KOLOM 1 (KIRI POJOK): Logo & Nama Desa -->
            <div class="space-y-2">
                <img src="{{ asset('images/logo-malang.png') }}" alt="Logo Kabupaten Malang" class="h-12 w-auto mb-2">
                <div>
                    <h3 class="text-base font-bold text-gray-900 leading-tight">Desa Jatisari</h3>
                    <p class="text-xs text-gray-600 leading-normal">Kecamatan Tajinan, Kabupaten Malang, Jawa Timur</p>
                </div>
            </div>

            <!-- KOLOM 2 (TENGAH/SEBELAH KANANNYA): Kantor Desa Jatisari -->
            <div class="text-xs text-gray-700 space-y-1.5">
                ...
                <p>
                    Email : <a href="mailto:desa.jatisari@malangkab.go.id" class="text-blue-600 hover:underline">desa.jatisari@malangkab.go.id</a> | No. Telp : 0341xxxxxx
                </p>
            </div>

            <!-- KOLOM 3 (KANAN POJOK): Media Sosial & Kebijakan Privasi -->
        ...
        <!-- BARIS BAWAH: Watermark / Copyright -->
